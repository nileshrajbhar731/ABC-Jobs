...
<title>User by profile Update</title>
<link rel="stylesheet"
...
<body>
	...
	<nav id="nav">
		...
		<ul>
			<li><a href="ProfilePage?email=<s:property value="email"/>">Dashboard</a></li>
	...
	<div class="container_main">
		<div class="container">
			...
			<div class="content">
				<form action="Userupdatedetails" method="post">
	...
	<s:else>
		<span style="color: red;"><s:property value='errorMsg' /></span>
						...
						<input  type="hidden" style="cursor: no-drop;" name="uemailhidden" value='<s:property value="email"/>'>
	...
	<s:else>
		<span style="color: red;"><s:property value='errorPhone' /></span>
					...
					<div class="button">
						...
						<a href="ProfilePage?email=<s:property value="email"/>"><button type="button">Back</button></a>
					</div>
				</form>
				<s:if test="ctr>0">
