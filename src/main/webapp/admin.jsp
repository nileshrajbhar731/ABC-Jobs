...
<nav id="nav">
	...
	<d:form action="myreport">
<button type="submit" name="Report">View Profile</button>
</d:form>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="profile-head">
                                    ...
                                    <p class="proile-rating">UserRole : <span><d:property value="userRole"/></span></p>
                    ...
                    <div class="col-md-2">
                       ...
                       <div class="a">
                        <a href="updatedetails.action?submitType=updatedata&email=<d:property value="email"/>">
                       ...
                       <br>
                       <div class="aa">
                        <a href="deletedata?email=<d:property value="email"/>">
