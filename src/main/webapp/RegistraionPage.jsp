...
<body>
	...
	<nav id="nav">
		...
		<ul>
			...
			<li><a class="active" href="RegistraionPage.jsp">Registration</a></li>
	...
	<div class="container_main">
		<div class="container">
			...
			<div class="content">
				<st:form action="myregister" method="post">
					<div class="user-details">
						...
						<div class="input-box">
						<h4><st:property value='errorPhone' /></h4>
							<span class="details">Phone Number</span> <input type="text"
								placeholder="Enter your number" name="phone" required />
						</div>
						<div class="input-box">
							<span class="details">Profession</span> <input type="text"
								placeholder="Enter your Profession" name="profession" required />
						</div>
						<div class="input-box">
					...
					<div class="gender-details">
						<input type="radio" name="gender" value="male" id="dot-1" required/> <input
							type="radio" name="gender" value="Female" id="dot-2" required/> 
						...
						<div class="category">
							...
							<div class="UserRole-details">
						  <input
							type="radio" name="userRole" value="admin" id="dot-3" required/>
							<input
							type="radio" name="userRole" value="user" id="dot-4" required/>
						<span class="UserRole-title">UserRole</span>
						<div class="category">
							
								<!-- using for UserRole -->
							 <label for="dot-3"> <span class="dot three"></span> <span
								class="UserRole">Admin(emergency services)</span>
							</label>
							<label for="dot-4"> <span class="dot four"></span> <span
								class="UserRole">user</span>
							</label>
						</div>
					</div>
